...
# This module implements various ways of computing cluster overlap.

# To implement exact overlap, we draw on the paper by Anderson and
# Bahadur (1962), as cited in the repliclust paper.
